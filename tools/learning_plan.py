...
# llm_45_turbo = ChatOpenAI(api_key=openai_api_key, model='gpt-4-turbo')
...
#     course_inventory = pd.read_csv('course_inventory.csv', encoding="latin")
#     user_inputs_dict = {
#         'user_id':101,
#         'selected_course_list': ['AI for Everyone','AI Agentic Design Patterns with AutoGen','Multi AI Agent Systems with crewAI'],
#         'schedule': '5-7 hours per week',
...
#     course_plan_df = build_learning_schedule(user_inputs = user_inputs_dict, course_inventory_df=course_inventory)
#     course_plan_df.to_excel('output/course_learning_plan_0620.xlsx', index=False)
