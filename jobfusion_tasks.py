...
class JobFusion_Tasks():
    ...
    def research_task(self, agent):
        return Task(description=dedent(f'''
            Analyze the provided job description from the given URL to extract all key skills, experiences, and qualifications required for the role. 
            Ensure that you thoroughly identify and capture every qualifications, including those that may be subtly embedded within the content of the job description.
            {self.__tip_section()}
